...
class Reference {
    ...
    const BASES = array(
	    ...
	    'vd17' => 'https://kxp.k10plus.de/DB=1.28/CMD?ACT=SRCHA&IKT=8079&TRM=%27{ID}%27', 
	    'vd18' => 'https://kxp.k10plus.de/DB=1.65/CMD?ACT=SRCHA&IKT=1007&TRM=VD18+{ID}', 
        ...
        'worldcat' => 'https://www.worldcat.org/de/title/{ID}',
	    'swissbib' => 'https://www.swissbib.ch/Record/{ID}',
	    'swisscov' => 'https://swisscovery.slsp.ch/permalink/41SLSP_NETWORK/1ufb5t2/{ID}',
	    ...
	    'stcn' => 'https://data.cerl.org/stcn/{ID}',
	    'gbv' => 'https://kxp.k10plus.de/DB=2.0/PPNSET?PPN={ID}',
	    'gvk' => 'https://kxp.k10plus.de/DB=2.0/PPNSET?PPN={ID}',
	    'k10plus' => 'https://kxp.k10plus.de/DB=2.0/PPNSET?PPN={ID}',
	    'ppn' => 'https://kxp.k10plus.de/DB=2.0/PPNSET?PPN={ID}',
