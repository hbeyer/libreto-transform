...
function addPlace($itemResource, $place) {
    if (!$place->placeName) {
        return;
    }
    $uri = '';
...
function addManifestation($itemResource, $item) {
...
function addWork($itemResource, $item) {
...
function addOriginalItem($itemResource, $item) {
