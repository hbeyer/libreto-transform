...
abstract class language_reference {
    ...
    static function getLanguage($code) {
        if (isset(language_reference::$languageCodes[$code])) {
            return(language_reference::$languageCodes[$code]);
        }
        return(null);
    }

    static function getCode($language) {
        foreach (language_reference::$languageCodes as $code => $label) {
            if ($label == $language) {
                return($code);
            }
        }
