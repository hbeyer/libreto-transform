...
class beacon_repository {
	...
	'pkb' => array('label' => 'Professorinnen- und Professorenkatalog der Otto-Friedrich-Universität Bamberg', 'location' => 'https://professorenkatalog.uni-bamberg.de/beacon', 'target' => 'https://professorenkatalog.uni-bamberg.de/gnd/{ID}', 'type' => 'default'),	    
        ...
        'mmlo' => array('label' => 'Biographisches Lexikon der Münzmeister, Wardeine, Stempelschneider und Medailleure (MMLO)', 'location' => 'http://mmlo.de/beacon', 'target' => 'http://mmlo.de/Q/GND={ID}', 'type' => 'default'),
