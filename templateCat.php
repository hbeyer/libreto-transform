...
$catalogue->title = '{Title of the historical catalogue}';
...
$catalogue->year = '{Year of the catalogue}';
...
$vatalogue->base = '{String to put before the image number to get a link to the respective page of the digitized catalogue}'; // Steht die Image-Nummer in der Mitte, wird sie durch {No} wiedergegeben. Relative Links zur Nutzung lokaler Bilder sind möglich.
